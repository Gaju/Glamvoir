...
public class QuickReturnListView extends ListView implements
    ...
    private void init() {
        ...
        final View mHeader = inflater.inflate(R.layout.scrollable_header, null);
    ...
    public void setQuickReturnView(final View quickReturnView) {
        ...
        mQuickReturnView.measure(
                ...
                MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
        params.height = mQuickReturnView.getMeasuredHeight() - getResources().getDimensionPixelSize(R.dimen.listview_swipe_progress_height);
    ...
    public void recomputeScrolY()
    {
        ...
        {
            mCachedVerticalScrollRange = 100000;
        }
        else
        {
            long height = 0;
            ...
            mCachedVerticalScrollRange = (int)height;
        }
    ...
    private int getComputedScrollY() {
        ...
        if(view != null) {
            ...
            if (pos == 0) {
                ...
                nScrollY = view.getHeight() * pos - nItemY;
            }
        }
        return nScrollY;
    }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        rawY = mPlaceHolder.getTop() -
                Math.min(/* TODO: mCachedVerticalScrollRange*/Integer.MAX_VALUE - getHeight(), mScrollY);
    ...
    private void showWithAnimation() {
        if (translationY > 0) {
            ...
            mState = STATE_OFFSCREEN;
            mMinRawY = rawY;
        } else if (ViewHelper.getTranslationY(mQuickReturnView) != 0
                && !noAnimation) {
            noAnimation = true;
